...
Ipv4L3Protocol::IpForward (Ptr<Ipv4Route> rtentry, Ptr<const Packet> p, const Ipv4Header &header)
{
  ...
  if((ipHeader.GetSource () ==  Ipv4Address("10.1.1.1") || ipHeader.GetSource () ==  Ipv4Address("10.1.1.2")) && ipHeader.GetProtocol () != Icmpv4L4Protocol::PROT_NUMBER && 
